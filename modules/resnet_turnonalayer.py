...
from modules.layers_turnonalayer import *
from util_turnonalayer import *
...
class Bottleneck(nn.Module):
    ...
    def simprop2(self,o,inference_pkg):
        ...
        o1 = self.relu2.simprop2(o1,inference_pkg) #,residual_input = if donwsample downsample(block_input) else block_input. 이걸로는 bias 분배만 계산할때 사용.. 차라리 bias 영향을 따로 simmap으로 빼는게 나을지도..? residual input은 그냥 자기 자신 보정해주면됨.
