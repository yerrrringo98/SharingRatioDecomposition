...
class ReLU(nn.ReLU):
    ...
    def choice_cal(self,input,o,inference_pkg):
    ...
    def simprop2(self,o,inference_pkg):
        ...
        if inference_pkg.probe == False:
            simmap_total = self.choice_cal(input,o,inference_pkg)
        else:
...
class Add():
    ...
    def simprop2(self,o,inference_pkg):
        o1 = o
        o2 = SimmapObj()
        o2.external_simmap = o1.external_simmap
        o2.last_layer_name = o1.last_layer_name
        o2.layer_list = o1.layer_list[:] # shallow copy
        o2.target_layer_name = o1.target_layer_name
        o2.simmap = o1.simmap.clone()
        return (o1,o2)
