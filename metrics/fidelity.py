...
class MuFidelity():
    ...
    def __init__(self,
                 ...
                 infer_pkg: Optional[InferencePkg] = None):
    ...
    def evaluate(self,
        ...
        for inp, label, phi, base in zip(self.inputs, self.targets, explanations,
            ...
            attrs = torch.sum(phi * (1.0 - self.subset_masks), (1, 2, 3))
